...
.php-success { background:#f0fdf4; border:1px solid #bbf7d0; color:#15803d; border-radius:var(--radius-md); padding:10px 14px; font-size:0.82rem; margin-bottom:16px; font-weight:500; }
...
.input-wrapper input {
    width:100%; height:44px; padding:0 42px 0 42px;
...
.forgot-link { display:block; text-align:right; font-size:0.78rem; color:var(--blue-600); text-decoration:none; margin:4px 0 16px; }
...
.btn-primary {
    ...
    box-shadow:0 4px 14px rgba(37,99,235,0.3); transition:all var(--transition-fast);
}
...
<div class="card-container">
    <div class="brand-panel">
        <div class="brand-content">
            ...
            <p class="brand-subtitle">Level up your knowledge</p>
            <p class="brand-tagline">Join thousands of students and test your skills with interactive quizzes.</p>
        </div>
    ...
    <div class="form-panel">
        <div class="form-wrapper">
            ...
            <?php if (!empty($success)): ?>
                <div class="php-success"><?= htmlspecialchars($success) ?></div>
            <?php endif; ?>
            ...
            <form method="POST" action="<?= defined('BASE_PATH') ? BASE_PATH : '' ?>/login">
                ...
                <a href="<?= defined('BASE_PATH') ? BASE_PATH : '' ?>/forgot-password" class="forgot-link">Forgot password?</a>
            ...
            <div class="form-footer">
                <p>Don't have an account? <a href="<?= defined('BASE_PATH') ? BASE_PATH : '' ?>/register">Create one</a></p>
            </div>
        </div>
    </div>
</div>
